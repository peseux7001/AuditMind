...
const shellContent = {
  ...
  nav: [
    { label: "대시보드", href: "/console", page: "dashboard", count: "" },
    { label: "고객사 관리", href: "/console?page=customers", page: "customers", count: "" },
    { label: "자료제출 요청", href: "/console?page=submission-requests", page: "submission-requests", count: "" },
    { label: "제출자료 검토", href: "/console?page=review", page: "review", count: "" },
    { label: "서비스 관리", href: "/console?page=templates", page: "templates", count: "" },
    { label: "자료 제출 포털 (고객용 데모)", href: "/submit/mvp-demo", page: "customer-test", count: "", separated: true },
  ],
  notifications: [],
